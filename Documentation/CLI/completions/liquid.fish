...
function __liquid_should_offer_completions_for_positional -a expected_commands expected_positional_index positional_index_comparison
...
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid" 1' -fa 'render' -d 'Render a Liquid template.'
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid" 1' -fa 'analyze' -d 'Analyze template structure and complexity.'
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid" 1' -fa 'batch' -d 'Batch-render multiple templates.'
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid" 1' -fa 'validate' -d 'Validate Liquid template syntax.'
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid" 1' -fa 'benchmark' -d 'Benchmark template rendering performance.'
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid" 1' -fa 'init' -d 'Initialize a new Liquid template project.'
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid" 1' -fa 'help' -d 'Show subcommand help information.'
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid render" 1' -fa '(set -l exts \'liquid\' \'html\';for p in (string match -e -- \'*/\' (commandline -t);or printf \n)*.{$exts};printf %s\n $p;end;__fish_complete_directories (commandline -t) \'\')'
...
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid analyze" 1' -fa '(set -l exts \'liquid\' \'html\';for p in (string match -e -- \'*/\' (commandline -t);or printf \n)*.{$exts};printf %s\n $p;end;__fish_complete_directories (commandline -t) \'\')'
...
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid batch" 1' -fa '(__liquid_complete_directories)'
...
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid validate" 1' -fa '(set -l exts \'liquid\' \'html\';for p in (string match -e -- \'*/\' (commandline -t);or printf \n)*.{$exts};printf %s\n $p;end;__fish_complete_directories (commandline -t) \'\')'
...
complete -c 'liquid' -n '__liquid_should_offer_completions_for_positional "liquid benchmark" 1' -fa '(set -l exts \'liquid\' \'html\';for p in (string match -e -- \'*/\' (commandline -t);or printf \n)*.{$exts};printf %s\n $p;end;__fish_complete_directories (commandline -t) \'\')'
